...
<required_reading>
Read `C:/WKWK/asiatekoracle/projects/asiastore-gsd/.codex/gsd-core/references/ai-frameworks.md` for framework profiles and known pitfalls before fetching docs.
</required_reading>
