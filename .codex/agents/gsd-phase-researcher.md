...
@C:/WKWK/asiatekoracle/projects/asiastore-gsd/.codex/gsd-core/references/thinking-models-research.md
...
```bash
node "C:/WKWK/asiatekoracle/projects/asiastore-gsd/.codex/gsd-core/bin/gsd-tools.cjs" graphify query "<capability-keyword>" --budget 1500
```
