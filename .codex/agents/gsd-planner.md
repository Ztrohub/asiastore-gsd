...
@C:/WKWK/asiatekoracle/projects/asiastore-gsd/.codex/gsd-core/references/mandatory-initial-read.md
...
**Project skills:** @C:/WKWK/asiatekoracle/projects/asiastore-gsd/.codex/gsd-core/references/project-skills-discovery.md
...
@C:/WKWK/asiatekoracle/projects/asiastore-gsd/.codex/gsd-core/references/planner-source-audit.md for full format, examples, and gap-handling rules.
...
@C:/WKWK/asiatekoracle/projects/asiastore-gsd/.codex/gsd-core/references/planner-source-audit.md for constraint examples.
...
**Test:** Could a different the agent instance execute without asking clarifying questions? If not, add specificity. See @C:/WKWK/asiatekoracle/projects/asiastore-gsd/.codex/gsd-core/references/planner-antipatterns.md for vague-vs-specific comparison table.

## TDD Detection

**When `workflow.tdd_mode` is enabled:** Apply TDD heuristics aggressively — all eligible tasks MUST use `type: tdd`. Read @C:/WKWK/asiatekoracle/projects/asiastore-gsd/.codex/gsd-core/references/tdd.md for gate enforcement rules and the end-of-phase review checkpoint format.
...
**When `MVP_MODE` is enabled (passed by the plan-phase orchestrator):** Decompose tasks as **vertical feature slices**, not horizontal layers. Required reading: `@C:/WKWK/asiatekoracle/projects/asiastore-gsd/.codex/gsd-core/references/planner-mvp-mode.md` (loaded conditionally by the orchestrator).
...
1. Frame the phase goal as a user story at the top of `PLAN.md`. The user story is sourced from the `**Goal:**` line in ROADMAP.md (set by `mvp-phase`). Emit it with bolded keywords:
   ...
   **As a** [user role], **I want to** [capability], **so that** [outcome].
   ...
   Format rules from `@C:/WKWK/asiatekoracle/projects/asiastore-gsd/.codex/gsd-core/references/user-story-template.md`:
...
**Walking Skeleton mode** (`WALKING_SKELETON=true`, set by orchestrator for Phase 1 + new project under `--mvp`): The first deliverable is a Walking Skeleton — the thinnest possible end-to-end stack. In addition to `PLAN.md`, produce `SKELETON.md` using the template at `@C:/WKWK/asiatekoracle/projects/asiastore-gsd/.codex/gsd-core/references/skeleton-template.md`. `SKELETON.md` records architectural decisions (framework, DB, auth, deployment, directory layout) that subsequent phases will build on without renegotiating.
...
<execution_context>
@C:/WKWK/asiatekoracle/projects/asiastore-gsd/.codex/gsd-core/workflows/execute-plan.md
@C:/WKWK/asiatekoracle/projects/asiastore-gsd/.codex/gsd-core/templates/summary.md
</execution_context>
...
@C:/WKWK/asiatekoracle/projects/asiastore-gsd/.codex/gsd-core/references/planner-antipatterns.md
...
```bash
node "C:/WKWK/asiatekoracle/projects/asiastore-gsd/.codex/gsd-core/bin/gsd-tools.cjs" graphify status
```
...
```bash
node "C:/WKWK/asiatekoracle/projects/asiastore-gsd/.codex/gsd-core/bin/gsd-tools.cjs" graphify query "<phase-goal-keyword>" --budget 2000
```
...
@C:/WKWK/asiatekoracle/projects/asiastore-gsd/.codex/gsd-core/references/thinking-models-planning.md
...
See @C:/WKWK/asiatekoracle/projects/asiastore-gsd/.codex/gsd-core/references/planner-chunked.md for `## OUTLINE COMPLETE` and `## PLAN COMPLETE` return formats used in chunked mode.
