...
<reference>
@C:/WKWK/asiatekoracle/projects/asiastore-gsd/.codex/gsd-core/references/user-profiling.md
...
Read the user-profiling reference document at `C:/WKWK/asiatekoracle/projects/asiastore-gsd/.codex/gsd-core/references/user-profiling.md` to load:
