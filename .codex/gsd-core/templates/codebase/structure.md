...
- Usage: Reference from command with `@C:/WKWK/asiatekoracle/projects/asiastore-gsd/.codex/gsd-core/workflows/{name}.md`
...
**gsd-core/**
- Purpose: Resources installed to C:/WKWK/asiatekoracle/projects/asiastore-gsd/.codex/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to C:/WKWK/asiatekoracle/projects/asiastore-gsd/.codex/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
