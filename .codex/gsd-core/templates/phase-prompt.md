...
<!-- For checkpoint task examples and patterns, see @C:/WKWK/asiatekoracle/projects/asiastore-gsd/.codex/gsd-core/references/checkpoints.md -->
...
See `C:/WKWK/asiatekoracle/projects/asiastore-gsd/.codex/gsd-core/references/tdd.md` for TDD plan structure.
...
See `C:/WKWK/asiatekoracle/projects/asiastore-gsd/.codex/gsd-core/templates/user-setup.md` for full schema and examples
...
See `C:/WKWK/asiatekoracle/projects/asiastore-gsd/.codex/gsd-core/workflows/verify-phase.md` for verification logic.
