...
<required_reading>
@C:/WKWK/asiatekoracle/projects/asiastore-gsd/.codex/gsd-core/references/ai-frameworks.md
@C:/WKWK/asiatekoracle/projects/asiastore-gsd/.codex/gsd-core/references/ai-evals.md
</required_reading>
...
```markdown
Read C:/WKWK/asiatekoracle/projects/asiastore-gsd/.codex/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "C:/WKWK/asiatekoracle/projects/asiastore-gsd/.codex/gsd-core/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read C:/WKWK/asiatekoracle/projects/asiastore-gsd/.codex/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read C:/WKWK/asiatekoracle/projects/asiastore-gsd/.codex/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read C:/WKWK/asiatekoracle/projects/asiastore-gsd/.codex/agents/gsd-eval-planner.md for instructions.
