...
> `--power` is present in `{{GSD_ARGS}}`. The full step-by-step instructions
...
```
Read @C:/WKWK/asiatekoracle/projects/asiastore-gsd/.codex/gsd-core/workflows/discuss-phase-power.md
```
