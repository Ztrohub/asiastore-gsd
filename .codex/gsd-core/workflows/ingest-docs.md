...
```bash
INIT=$(node "C:/WKWK/asiatekoracle/projects/asiastore-gsd/.codex/gsd-core/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "C:/WKWK/asiatekoracle/projects/asiastore-gsd/.codex/gsd-core/bin/gsd-tools.cjs" commit \
