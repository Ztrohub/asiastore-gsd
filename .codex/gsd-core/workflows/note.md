...
- **Global scope**: `C:/WKWK/asiatekoracle/projects/asiastore-gsd/.codex/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `C:/WKWK/asiatekoracle/projects/asiastore-gsd/.codex/notes/`)
...
2. Glob `C:/WKWK/asiatekoracle/projects/asiastore-gsd/.codex/notes/*.md` (if directory exists) — global notes
...
Global (C:/WKWK/asiatekoracle/projects/asiastore-gsd/.codex/notes/):
...
2. **No `.planning/`**: Falls back to global `C:/WKWK/asiatekoracle/projects/asiastore-gsd/.codex/notes/` — works in any directory
