...
```
Agent(
  prompt="Read C:/WKWK/asiatekoracle/projects/asiastore-gsd/.codex/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/WKWK/asiatekoracle/projects/asiastore-gsd/.codex/gsd-core/templates/SECURITY.md`
