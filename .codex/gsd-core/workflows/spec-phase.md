...
```bash
INIT=$(node "C:/WKWK/asiatekoracle/projects/asiastore-gsd/.codex/gsd-core/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @C:/WKWK/asiatekoracle/projects/asiastore-gsd/.codex/gsd-core/templates/spec.md.
