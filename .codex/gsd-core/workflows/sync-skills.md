...
INSTALL_JS_GLOBAL="C:/WKWK/asiatekoracle/projects/asiastore-gsd/.codex/gsd-core/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node C:/WKWK/asiatekoracle/projects/asiastore-gsd/.codex/gsd-core/bin/install.js --global --<runtime>
```
Then exit.
