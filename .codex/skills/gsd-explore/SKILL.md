...
metadata:
  short-description: "Socratic ideation and idea routing — think through ideas before committing to plans"
---

<codex_skill_adapter>
## A. Skill Invocation
- This skill is invoked by mentioning `$gsd-explore`.
- Treat all user text after `$gsd-explore` as `{{GSD_ARGS}}`.
...
<execution_context>
@C:/WKWK/asiatekoracle/projects/asiastore-gsd/.codex/gsd-core/workflows/explore.md
</execution_context>
