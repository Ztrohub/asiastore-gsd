...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `C:/WKWK/asiatekoracle/projects/asiastore-gsd/.codex/.gsd-surface.json`
(sibling to `C:/WKWK/asiatekoracle/projects/asiastore-gsd/.codex/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `C:/WKWK/asiatekoracle/projects/asiastore-gsd/.codex/skills/gsd-*/`.
...
(`~/.codex`), NOT the skills sub-directory (`C:/WKWK/asiatekoracle/projects/asiastore-gsd/.codex/skills`).
...
`C:/WKWK/asiatekoracle/projects/asiastore-gsd/.codex/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `C:/WKWK/asiatekoracle/projects/asiastore-gsd/.codex/.gsd-surface.json`).
...
<execution_context>
Surface state file: `C:/WKWK/asiatekoracle/projects/asiastore-gsd/.codex/.gsd-surface.json`
Install profile marker: `C:/WKWK/asiatekoracle/projects/asiastore-gsd/.codex/.gsd-profile`
Skill dirs: `C:/WKWK/asiatekoracle/projects/asiastore-gsd/.codex/skills/gsd-*/`
Engine module: `C:/WKWK/asiatekoracle/projects/asiastore-gsd/.codex/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `C:/WKWK/asiatekoracle/projects/asiastore-gsd/.codex/gsd-core/bin/lib/clusters.cjs`
</execution_context>
